# algorithms/algoritmo2.py – CW + Tabu Search (con aplastado válido)
...
def optimizar_ruta_cw_tabu(data: Dict[str, Any], tiempo_max_seg: int = 60) -> Dict[str, Any] | None:
    depot = data["depot"]
    ...
    # Intentamos aplastar si todo salió bien
    clientes = []
    ...
    if not feas or len(ruta_final) != len(llegada_final):
        return None  # Sin solución global factible
